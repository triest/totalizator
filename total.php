...
echo "вернет 1 (счет угадан полностью): \n";
echo(score(0, 1, 0, 1));echo("\n");// вернет 1 (счет угадан полностью)
echo "вернет 0 (угадано какая команда выиграла): \n";
echo(score(2, 1, 1, 0));echo("\n");// вернет 0 (угадано какая команда выиграла)
echo "вернет 0 (угадано какая команда выиграла) (другая команды) \n";
echo(score(2, 3, 1, 2));echo("\n");// вернет 0 (угадано какая команда выиграла) (другая команды)
echo "вернет -1 (ничего не угадано) \n";
